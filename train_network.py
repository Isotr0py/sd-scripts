        ...
        for epoch in range(num_train_epochs):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                with accelerator.accumulate(network):
                    ...
                    w = [v for k,v in network.named_parameters() if v.grad is not None]
                    print(f"\nRank {accelerator.process_index}, loss: {loss:.3f}, weight: {w[0].mean().item():.5f}, grad: {w[0].grad.mean().item():.7f}, sync:{accelerator.sync_gradients}")
